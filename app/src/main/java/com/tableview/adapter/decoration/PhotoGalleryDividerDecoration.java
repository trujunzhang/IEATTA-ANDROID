package com.tableview.adapter.decoration;
 ...
 * ListView.
 */
public class PhotoGalleryDividerDecoration extends RecyclerView.ItemDecoration {

    public PhotoGalleryDividerDecoration(Context context) {
