...
public class RestaurantDetailFragment extends DetailFragment {
    ...
    protected void reloadPage() {
        ...
        this.manager.setSectionItems(CollectionUtil.createList(new IEAGalleryThumbnail(this.task.galleryCollection)), RestaurantDetailSection.section_gallery_thumbnail.ordinal());
